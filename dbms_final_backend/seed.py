...
def seed():
    ...
    try:
        ...
        courses_to_seed = [
            ...
            ("703100004", "雲端運算 (Cloud Computing)", 3, [CAT_ELECTIVE]),
            ("703100005", "行動應用程式設計 (Mobile App Development)", 3, [CAT_ELECTIVE]),
            ("703100006", "網頁程式設計 (Web Programming)", 3, [CAT_ELECTIVE]),
            ("703100007", "自然語言處理 (Natural Language Processing)", 3, [CAT_ELECTIVE]),
            ("703100008", "計算機視覺 (Computer Vision)", 3, [CAT_ELECTIVE]),
            ("703100009", "區塊鏈技術 (Blockchain Technology)", 3, [CAT_ELECTIVE]),
            ("703100010", "物聯網概論 (Internet of Things)", 3, [CAT_ELECTIVE]),
            ("703100011", "平行程式設計 (Parallel Programming)", 3, [CAT_ELECTIVE]),
            ("703100012", "資訊科學專題討論 (CS Seminar)", 1, [CAT_ELECTIVE]),
            ("703100013", "數位影像處理 (Digital Image Processing)", 3, [CAT_ELECTIVE]),
            ("703100014", "推薦系統 (Recommender Systems)", 3, [CAT_ELECTIVE]),
            # ── 英文 ──────────────────────────────────────
        ...
        records_data = [
            # ────────────────────────────────────────────────
            # 學生1：王大明（111001001）總學分 119，缺 3 學分必修
            # ────────────────────────────────────────────────
            # 一般必修 15 門
            ...
            ("111001001", "114/2", "703100013", 50, False),
            ("111001001", "114/2", "703100014", 50, False),
